---
{"dg-publish":true,"permalink":"/03-resources/ai-and-data/weaviate-vector-db/","tags":["compilation"]}
---
...
We will start with the example we discussed in [[03 Resources/AI and Data/Vector DB\|Vector DB]] where we were storing time and activity for the day. And we wanted to query what I was doing around that time. 
...
![Screenshot 2025-08-26 at 9.17.21 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-26%20at%209.17.21%20PM.png)
...
![Screenshot 2025-08-26 at 9.27.57 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-26%20at%209.27.57%20PM.png)
...
> We should have used [[03 Resources/AI and Data/dot product\|dot product]] to find the correct activity around a time.
...
For key search, Weaviate uses [[03 Resources/AI and Data/BM25\|BM25]] relevance, which is like [[elastic search\|elastic search]].
