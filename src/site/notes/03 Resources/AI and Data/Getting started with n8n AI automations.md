---
{"dg-publish":true,"permalink":"/03-resources/ai-and-data/getting-started-with-n8n-ai-automations/","tags":["compilation","n8n","automation","deepseek"]}
---
...
![Screenshot 2025-08-23 at 3.40.28 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%203.40.28%20PM.png)
...
![Screenshot 2025-08-23 at 3.52.05 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%203.52.05%20PM.png)
...
2. No need to change any config in the opened tab. Just click back to canvas on top left. 
   Now your workflow will show the chat action. You can enter any text in the chat area and see the message output here. 
      ![Screenshot 2025-08-23 at 3.55.10 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%203.55.10%20PM.png)
3. Next, click on the plus icon and add `AI Agent`, again no need to change anything.
   ...
   ![Screenshot 2025-08-23 at 3.57.23 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%203.57.23%20PM.png)
4. Next we will add chat model, click on the plus icon pointing to chat model. Here, you will select `Ollama Chat Model`. 
   ...
   ![Screenshot 2025-08-23 at 3.59.49 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%203.59.49%20PM.png)
   Now, your workflow will start looking something like this.
   ![Screenshot 2025-08-23 at 4.01.22 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%204.01.22%20PM.png)
5. You will need to add credentials to direct the Ollama instance. 
   ...
   ![Screenshot 2025-08-23 at 4.28.54 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%204.28.54%20PM.png)
6. Now you can run your workflow and it will connect to `deepseek` model and provide you responses. Simply say `Hi` to the model and here is how it runs like.
   ![Screenshot 2025-08-23 at 4.00.21 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%204.00.21%20PM.png)
7. The response, contains both the thinking part which is between `<think></think>` blocks and after this is the final output. 
   ![Screenshot 2025-08-23 at 4.01.11 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%204.01.11%20PM.png)
...
![Screenshot 2025-08-23 at 4.04.43 PM.png](/img/user/99%20Attachments/Screenshot%202025-08-23%20at%204.04.43%20PM.png)
