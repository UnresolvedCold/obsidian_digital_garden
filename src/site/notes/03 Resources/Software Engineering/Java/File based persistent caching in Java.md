---
{"dg-publish":true,"permalink":"/03-resources/software-engineering/java/file-based-persistent-caching-in-java/","tags":["compilation","insight","java","MapDB","Caching","Persistent","DB","ACID","MemoryMapped","MMap","File"]}
---
...
And the best way to store your cache in a persistent file is using [[03 Resources/Software Engineering/Java/memory mapped file\|memory mapped file]] in Java. 
...
```
 ...
 The in-memory cache is just a concurrent hash map and persistent cache is HTreeMap which is stored and serialized in a [[03 Resources/Software Engineering/Java/memory mapped file\|memory mapped file]].
